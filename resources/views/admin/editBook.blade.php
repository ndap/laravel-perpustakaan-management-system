<x-admin-layout>
        ...
        <div class="relative bg-white/80 backdrop-blur-sm border border-gray-100 rounded-2xl p-6 shadow-lg">
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Edit Buku</h1>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <form 
            ...
            x-data="{
                isDragging: false,
                previewUrl: '{{ $book->image ? Storage::url($book->image) : '' }}',
                fileName: '',
                handleDrop(e) {
        ...
        >
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-3">
                        <div class="flex items-center gap-2">
                            ...
                            Cover Buku
                            <span class="text-gray-500 text-xs font-normal">(kosongkan jika tidak ingin mengubah)</span>
                        </div>
                    </label>
                        ...
                        <div class="text-center">
                            <template x-if="previewUrl">
                                <div class="relative inline-block">
                                    ...
                                    <p class="text-xs text-gray-500 mt-3" x-text="fileName || 'Cover saat ini'"></p>
                                </div>
                            </template>
                            <template x-if="!previewUrl">
                                <div>
            ...
            <div class="mt-8 flex justify-end gap-3 pt-6 border-t-2 border-gray-100">
                ...
                <button 
                    type="submit"
                    class="px-8 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/50 hover:scale-105"
                >
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
